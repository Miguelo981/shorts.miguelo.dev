...
const faqs = [
  {
    ...
    content: (
      <>
        ...
        <p>Web3 Shorts is URL shortener where you can create and manage short links and track their click statistics.</p>
            
        <p>Web3 Shorts is URL Shortener for creating branded short links. Short links created in Web3 Shorts can be short links on the cutt.ly domain or short links on your own custom domain.</p>
            
        <p>Web3 Shorts URL Shortener also allows you to use your own name, aliases otherwise known as back-half of a short link, so that each short link can be perfectly readable to the audience and generate more clicks than in the case of a standard URL.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>Web3 Shorts is a custom URL shortener that allows advanced editing of short links so that you can support your brand.</p>
            
        <p>With Web3 Shorts you can edit your short links in many ways. You can create random short links where the back-half of the short link is a random string of characters, but you can also give your own name and change the back-half of the short link in any way to make it more readable for your audience.</p>
            
        <p>It&apos;s not everything. In Web3 Shorts, you can also change the front-half of the short link, i.e. the domain to your own custom domain, and create short links that will support your brand.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>A short link is a link that has been shortened with a URL shortener. The short link redirects to the target URL. Web3 Shorts&apos;s URL shortener allows you to manage a short link - you can change the back-half of a short link to your own. With Web3 Shorts you can also manage ketos links. A standard short link is created in the domain that the link shortener assigns, in Web3 Shorts it will be a link in the domain cutt.ly. There are also branded short links that you can easily create in Web3 Shorts.</p>
      </>
    ),
  },
]
      ...
      <div className='mx-8 md:mx-12 xl:mx-20'>
          <section id="home" className='grid justify-items-center items-center h-screen'>
            <div className='flex justify-center items-center'>
              ...
              <Image loading='lazy' alt="Blockchain web3 servers pointing" width="640" height="423" className='w-1/2 hidden md:block' src='/assets/images/web3-bg-1.png' />
            </div>
          </section>
          <section id="about-us" className='grid justify-items-center items-center h-screen relative'>
            ...
            <div style={{ backgroundImage: `url("assets/images/web3-bg-2.png")` }} className='w-1/2 h-[40rem] bg-no-repeat bg-contain bottom-0 right-40 md:right-80 xl:-right-[35vw] absolute z-10' />
              <div className='z-20 max-w-full md:max-w-[50vw] text-center'>
                ...
                <p className='text-xl mb-12'>Powered by Metamask Wallet and <a className='text-pink-500 font-semibold' href="https://github.com/Miguelo981/web3-token" target="_blank" rel="noreferrer">Web3 Token</a> authentication. ¡No Email, Password or Billing is needed!</p>
                <div className="sticky">
            ...
            <div className='z-20 text-center'>
              ...
              <div className='flex flex-col md:flex-row justify-center items-center gap-6'>
                ...
                <div className="w-full md:w-1/2 h-[25rem] perspective">
                  <Image loading='lazy' alt="Web3 Shorts app dashboard screenshot" width="734" height="447" src="/assets/images/app-screenshot.png" className="w-full h-auto rounded-2xl shadow-2xl shadow-pink-500 preserve-3d my-rotate-y-5" />
                </div>
              </div>
              {/* <div className='relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000'>
                <Image className='' src="/assets/images/app-screenshot.png" alt="" />
              </div> */}
            </div>
          </section>
